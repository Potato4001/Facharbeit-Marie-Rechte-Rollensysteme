                    ...
                    <div class="flex flex-col">
                        <div class="ml-32 mt-20">
                            ...
                            <div class="flex inline-flex items-center my-20">
                                <div class="flex inline-flex items-center mr-20 px-3 py-2 bg-green-700 rounded-full text-white font-bold text-lg">
                                ...
                                <div class="flex inline-flex items-center px-3 py-2 bg-green-700 rounded-full text-white font-bold text-lg">
